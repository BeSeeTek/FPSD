...
ENeg=[0x40,0x01,0x00] #6th Bridge backwards
EPos=[0x80,0x01,0x00] #6th Bridge forwards
Null=[0x00,0x00,0x00]
steps={
...
if __name__ == "__main__":
    ...
    """
    step1 ['0x40', '0xd1', '0xc2']
    step2 ['0x40', '0x51', '0xdc']
    step3 ['0x40', '0x81', '0xdf']
    step4 ['0x0', '0xe0', '0xdf']
    step5 ['0x80', '0xe1', '0x1f']
    step6 ['0x80', '0xe1', '0xa3']
    step7 ['0x80', '0x61', '0xb4']
    step8 ['0x40', '0x81', '0xb6']
    step9 ['0x0', '0xd0', '0xb6']
    step10 ['0x40', '0xd1', '0x16']
    """